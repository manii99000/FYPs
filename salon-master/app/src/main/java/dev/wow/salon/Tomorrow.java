...
import dev.wow.salon.viewModels.Tomorrow_view_model;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.barber_menu_view_wallet:
                TomorrowDirections.ActionTomorrowToBarberWallet action2 = TomorrowDirections.actionTomorrowToBarberWallet();
            ...
            case R.id.barber_menu_logout:
                ...
                NavOptions navOptions = new NavOptions.Builder()
                        .setPopUpTo(R.id.tomorrow, true)
                        .build();
                Navigation.findNavController(getView()).navigate(R.id.action_tomorrow_to_home,null,navOptions);
                return true;
            default:
