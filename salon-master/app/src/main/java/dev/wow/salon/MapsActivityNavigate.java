...
import dev.wow.salon.models.Result;
import dev.wow.salon.models.Route;
import dev.wow.salon.models.events.BeginJourneyEvent;
import dev.wow.salon.models.events.CurrentJourneyEvent;
import dev.wow.salon.models.events.EndJourneyEvent;
import dev.wow.salon.utils.JourneyEventBus;
...
public class MapsActivityNavigate extends FragmentActivity implements GoogleMap.OnMyLocationButtonClickListener,
        GoogleMap.OnMyLocationClickListener,
        OnMapReadyCallback {

    private static final String TAG = MapsActivityNavigate.class.getSimpleName();
    ...
    public static String salon_cord;
    public static String cust_cord;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "oncreate mapactivitynavi", Toast.LENGTH_SHORT).show();

        phonenumber = FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber().substring(1);
        custref = FirebaseDatabase.getInstance().getReference().child("customer").child(phonenumber);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mapFragment.getMapAsync(MapsActivityNavigate.this);
                //Toast.makeText(MapsActivityNavigate.this, "Customer coord " + cust_cord + "salon coord" + salon_cord, Toast.LENGTH_SHORT).show();
                //Toast.makeText(MapsActivityNavigate.this, "address  ", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void useValue(String yourValue) {
        fetched = yourValue;
        Toast.makeText(MapsActivityNavigate.this, "address  " + fetched, Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final double latitude = 33.749888;
        double longitude = 73.201321;
        ...
        custref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(phonenumber).exists()) {
                    Toast.makeText(MapsActivityNavigate.this, ""+ dataSnapshot.child("address").getValue().toString(), Toast.LENGTH_SHORT).show();
                }
            }
        ...
        sydney = new LatLng(33.593316, 73.055694);
        ...
        apiInterface.getDirections("driving", "less_driving",
                "33.739742,73.197375", "33.749888,73.201321",
