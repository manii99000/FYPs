...
import dev.wow.homeservices.viewModels.Customer_booked_appointments_view_model;
...
public class Customer_booked_appointment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        track = (Button) view.findViewById(R.id.button3);
    ...
    public void onStart() {
        ...
        track.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent myIntent = new Intent(getActivity(), TrackActivity.class);
