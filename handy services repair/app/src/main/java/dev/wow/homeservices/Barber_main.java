...
import dev.wow.homeservices.viewModels.Barber_main_view_model;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.barber_menu_edit_profile:
                ...
                return true;
            case R.id.barber_menu_view_wallet:
                Barber_mainDirections.ActionBarberMainToBarberWallet action2 = Barber_mainDirections.actionBarberMainToBarberWallet();
                action2.setPhonenumber(phonenumber);
                Navigation.findNavController(getView()).navigate(R.id.action_barber_main_to_barberWallet);
                return true;
