...
import dev.wow.homeservices.viewModels.Tomorrow_view_model;
...
//        logout = (Button) view.findViewById(R.id.btn_logout_barber2);
        ...
        myref = FirebaseDatabase.getInstance().getReference().child("homeservice").child(phonenumber).child(date);
