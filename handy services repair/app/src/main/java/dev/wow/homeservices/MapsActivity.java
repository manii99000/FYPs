...
import dev.wow.homeservices.viewModels.Sign_in_view_model;
...
public class MapsActivity extends FragmentActivity implements GoogleMap.OnMyLocationButtonClickListener,
    ...
    public void onMyLocationClick(@NonNull Location location) {
        ...
        SharedPreferences prefs =  this.getApplicationContext().getSharedPreferences("my_prefs", MODE_PRIVATE);
        SharedPreferences.Editor edit = prefs.edit();
        edit.putString("LOC", location.toString() );
        edit.commit();
        this.finish();
