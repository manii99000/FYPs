...
import dev.wow.homeservices.viewModels.Services_by_barber_view_model;
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (box_haircut.isChecked()) {
                    mviewmodel.setvalue("hardwarerepair", rate_haircut.getText().toString());
                } else {
                    mviewmodel.setvalue("hardwarerepair", "0");
                }
                if (box_hairspa.isChecked()) {
                    mviewmodel.setvalue("electricrepair", rate_hairspa.getText().toString());
                } else {
                    mviewmodel.setvalue("electricrepair", "0");
                }
                if (box_haircolor.isChecked()) {
                    mviewmodel.setvalue("acrepair", rate_haircolor.getText().toString());
                } else {
                    mviewmodel.setvalue("acrepair", "0");
                }
                if (box_massage.isChecked()) {
                    mviewmodel.setvalue("plumberservice", rate_massage.getText().toString());
                } else {
                    mviewmodel.setvalue("plumberservice", "0");
                }
                if (box_facial.isChecked()) {
                    mviewmodel.setvalue("paintservice", rate_facial.getText().toString());
                } else {
                    mviewmodel.setvalue("paintservice", "0");
                    ;
                }
                if (box_bleach.isChecked()) {
                    mviewmodel.setvalue("refrigerateservice", rate_bleach.getText().toString());
                } else {
                    mviewmodel.setvalue("refrigerateservice", "0");
                }
